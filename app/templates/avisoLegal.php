...
<li>Fax:</li>
<li>e-Mail:</li>
<li>Inscrita en el Registro:</li>
<li>Nombre de dominio:</li>
<li>Autorización administrativa:</li>
</ul>
</p>
<h1>OBJETO</h1>
...
Toda persona que acceda a este sitio web asume el papel de usuario, comprometiéndose a la observancia y cumplimiento riguroso de las disposiciones aquí dispuestas, así como a cualesquiera otra disposición legal que fuera de aplicación.</p>
<p>El prestador se reserva el derecho a modificar cualquier tipo de información que pudiera aparecer en el sitio web, sin que exista obligación de preavisar o poner en conocimiento de los usuarios dichas obligaciones, entendiéndose como suficiente con la publicación en el sitio web del prestador.
TERCERO DE CONFIANZA Y Código de Conducta </p>
<p>El prestador se encuentra adherido al código de conducta (Indicar Código de Conducta y link al mismo) que puede ser visualizado, descargado y/o impreso desde el link referenciado. Este código de conducta garantiza a los usuarios que el sitio web cumple con la legislación vigente y se encuentra sometido a todas las obligaciones dispuestas en dicho código.</p>
<p>El código de conducta (nombre del código de conducta) dispone de un sello de confianza, que es emitido de forma única y exclusiva para cada uno de los prestadores adheridos. El sello en posesión del prestador dispone del código de identificación [XXXXX], así como todos los datos identificativos del prestador.</p>
<p>El certificado será valido para el sitio web del prestador durante el plazo de 1 año desde la fecha de su emisión. Toda la información sobre la emisión del certificado y sobre las obligaciones de la entidad son accesibles por parte de los usuarios a través del siguiente link.
</p>
...
<p>Obligatoriedad o no de facilitarlos, así como las consecuencias en caso de no facilitarlos.
