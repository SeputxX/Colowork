 <?php ob_start() ?>
<h1 style="text-align: center; margin-top:5px;" class="titOfe">Bienvenido a ColoWork</h1>
<img class="imgini" src="../web/img/conferencia.jpg">
<br>
<h3 style="text-align: center; margin-top:20px !important" class="titOfe">¿Qué es ColoWork?</h3>
<p class="texto">	
